...
Bảng dưới đây thể hiện điểm số trung bình của các metric RAGAS trên từng phân vùng câu hỏi, dựa trên dữ liệu tính toán thực tế từ pipeline (không phải offline fixture đồng điểm 1.0).
